 ...
 * [DetalleDePersonajeFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [DetalleDePersonajeFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class DetalleDePersonajeFragment : Fragment(), OnClickListener {
    ...
    companion object {
         ...
         * @return A new instance of fragment DetalleDePersonajeFragment.
         */
        // TODO: Rename and change types and number of parameters
        fun newInstance(param1: String, param2: String): DetalleDePersonajeFragment {
            val fragment = DetalleDePersonajeFragment()
            val args = Bundle()
